...
- ✅ **Упрощен выбор категорий**
  - Заменен сложный компонент CategorySelector на простой select dropdown
  - Показываются только выбираемые категории (пропускаются родительские с подкатегориями)
  - Подкатегории отображаются с префиксом "└─" для визуального отличия
  - Логика: если у категории есть подкатегории, её нельзя выбрать (нужно выбрать подкатегорию)
...
- Простой select для выбора категорий (только конечные категории)
